...
export default function CenterDetailPage() {
    ...
    const updatePricing = useMutation({
        mutationFn: (body) => api.put(`/wallet/centers/${tenantId}/pricing`, body).then((r) => r.data),
        onSuccess: () => {
